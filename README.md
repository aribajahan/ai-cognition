...
I started with an adult-focused evidence map of research on memory, learning and skill, judgment, attention, and self-assessment. The corpus also includes a small number of studies outside a strict adult-only definition when they are important to the question, including a high-school mathematics field experiment. The evidence needs to be read in light of the people and tasks each study actually tested.
